...
class MoquetteWrapper() {// Moquette 브로커를 초기화하고 시작하며, 연결 및 연결 끊김 이벤트를 처리하고, SYS 메시지를 생성하여 MQTT 클라이언트에 퍼블리시합니다.
    ...
    fun start(properties: Properties) {//mqtt브로커를 시작하고connectionlistener포함
